...
public class BackBufferTerminal extends JediTerminal {
    ...
    public BackBufferTerminal(TerminalTextBuffer terminalTextBuffer, StyleState initialStyleState) {
    ...
    private BackBufferTerminal(@NotNull BackBufferDisplay bufferDisplay,
                               @NotNull TerminalTextBuffer terminalTextBuffer, @NotNull StyleState initialStyleState) {
