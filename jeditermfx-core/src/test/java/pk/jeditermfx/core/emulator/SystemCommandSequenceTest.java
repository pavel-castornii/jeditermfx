...
import pk.jeditermfx.core.emulator.SystemCommandSequence;
import static pk.jeditermfx.core.util.Ascii.BEL_CHAR;
import static pk.jeditermfx.core.util.Ascii.ESC_CHAR;
