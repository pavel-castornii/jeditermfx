package pk.jeditermfx.core.emulator;

import pk.jeditermfx.core.TerminalDataStream;
import pk.jeditermfx.core.DataStreamIteratingEmulator;
 ...
 * <p/>
 * Obtains data from the  {@link com.jediterm.terminal.TerminalDataStream}, interprets terminal ANSI escape
 * sequences as commands and directs them as well as plain data characters to
 * the  {@link com.jediterm.terminal.Terminal}
 *
 * @author traff
 */
