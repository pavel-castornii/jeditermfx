...
import pk.jeditermfx.core.emulator.mouse.TerminalMouseListener;
import pk.jeditermfx.core.emulator.mouse.MouseFormat;
import pk.jeditermfx.core.TerminalCustomCommandListener;
import pk.jeditermfx.core.TerminalDisplay;
import pk.jeditermfx.core.TerminalOutputStream;
import pk.jeditermfx.core.RequestOrigin;
...
import pk.jeditermfx.core.CursorShape;
import pk.jeditermfx.core.TerminalKeyEncoder;
import pk.jeditermfx.core.Color;
import pk.jeditermfx.core.util.Platform;
import pk.jeditermfx.core.TerminalCoordinates;
...
import pk.jeditermfx.core.emulator.charset.CharacterSet;
import pk.jeditermfx.core.emulator.charset.GraphicSet;
import pk.jeditermfx.core.emulator.charset.GraphicSetState;
import pk.jeditermfx.core.model.hyperlinks.LinkResultItem;
import pk.jeditermfx.core.model.hyperlinks.TextProcessing;
import pk.jeditermfx.core.util.CharUtils;
...
/**
 * Terminal that reflects obtained commands and text at {@link TerminalDisplay}(handles change of cursor position,
 * screen size etc) and  {@link TerminalTextBuffer}(stores printed text)
 *
 * @author traff
 */
public class JediTerminal implements Terminal, TerminalMouseListener, TerminalCoordinates {
    ...
    public JediTerminal(@NotNull TerminalDisplay display, @NotNull TerminalTextBuffer buf,
