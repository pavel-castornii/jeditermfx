...
import pk.jeditermfx.core.input.KeyEvent;
...
public class TerminalStarter implements TerminalOutputStream {
    ...
    public TerminalStarter(@NotNull JediTerminal terminal, @NotNull TtyConnector ttyConnector,
    ...
    public static void resize(@NotNull Emulator emulator, @NotNull Terminal terminal,
                              @NotNull TtyConnector ttyConnector, @NotNull TermSize newTermSize, @NotNull RequestOrigin origin,
